...
ggplot(data=msleep,
  ...
  labs(
    x="Body weight",
    y="Total sleep time",
    title="Relationship between Bodyweight and Sleep")
```
...
ggplot(data=msleep,
  ...
  labs(
    x="Body weight",
    y="Brain weight",
    title="Relationship between Bodyweight and Brainweight")
```
...
```{r}
ggplot(data=msleep,
       mapping=aes(x=awake, y=sleep_total, color=vore)) +
   geom_point() +
  labs(
    x="Awake time (hours)",
    y="Total sleep time (hours)",
    title="Relationship between awake and sleep time")
```
```
