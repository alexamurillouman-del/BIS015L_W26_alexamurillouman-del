...
```{r}
mountain_names <- c ("Mount Everest, K2, Kangchenjunga, Lhotse, Makalu")
Height_feet <- c (29032, 2851, 28169, 27940, 27838)
Height_meters <- c (8849, 8611, 8586, 8516, 8485)
```

**2. Combine these vectors into a data frame called `mountains`.**
```{r}
mountains <- data.frame(mountain_names, Height_feet, Height_meters)
```
...
```{r}
summits <- c (1200, 400, 300, 1000, 200)
```
